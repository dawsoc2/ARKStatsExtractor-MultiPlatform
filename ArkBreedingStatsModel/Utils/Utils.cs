...
namespace ArkBreedingStatsModel.Utils
{
    static class Utils
    {
        ...
        public static string LevelPercentile(int level)
        {
            ...
            return string.Format("topPercentileLevel", prb[level].ToString("N2"));
        }
        ...
        public static string StatName(int statIndex, bool abbreviation = false, Dictionary<string, string> customStatNames = null)
        {
            ...
            {
                return abbreviation ? $"{statName}_Abb" : statName;
            }
        ...
        {
            var multipliers = Values.Values.V.currentServerMultipliers;

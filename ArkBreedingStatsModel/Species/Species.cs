...
namespace ArkBreedingStatsModel.Species
{
    ...
    public class Species
    {
        ...
        /// </summary>
        [JsonProperty]
        private int displayedStats = displayedStatsDefault;
        ...
        private void Initialize(StreamingContext context)
        {
            ...
            stats = new CreatureStat[Values.Values.STATS_COUNT];
            if (altBaseStatsRaw != null)
                altStats = new CreatureStat[Values.Values.STATS_COUNT];

            usedStats = 0;
            double[][] completeRaws = new double[Values.Values.STATS_COUNT][];
        ...
        public void SetCustomImprintingMultipliers(double?[] overrides)
        {
            ...
            double[] overrideValues = new double[Values.Values.STATS_COUNT];
        ...
        {
            return obj != null && obj is Species other && !string.IsNullOrEmpty(other.blueprintPath) && other.blueprintPath == blueprintPath;
        }
        ...
        public byte[] RandomSpeciesColors(Random rand = null)
        {
            ...
            for (int ci = 0; ci < ColorRegionCount; ci++)
            {
                ...
                if (colors[ci]?.naturalColors != null && colorCount != 0)
                    randomColors[ci] = (byte)colors[ci].naturalColors[rand.Next(colorCount)].Id;
                else randomColors[ci] = (byte)(6 + rand.Next(50));
            }

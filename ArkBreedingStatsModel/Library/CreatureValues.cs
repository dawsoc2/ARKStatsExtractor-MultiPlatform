...
namespace ArkBreedingStatsModel.Library
{
    ...
    public class CreatureValues
    {
        ...
        public Sex sex;
        [JsonProperty]
        public double[] statValues = new double[Values.Values.STATS_COUNT];
        [JsonProperty]
        public int[] levelsWild = new int[Values.Values.STATS_COUNT];
        [JsonProperty]
        public int[] levelsDom = new int[Values.Values.STATS_COUNT];
        [JsonProperty]
        public int level;
        [JsonProperty]
        ...
        [JsonIgnore]
        public byte[] colorIDs = new byte[ArkBreedingStatsModel.Species.Species.ColorRegionCount];
        ...
        public CreatureValues(Species.Species species, string name, string owner, string tribe, Sex sex,
        ...
        public Species.Species Species
        {
            ...
            get
            {
                if (_species == null)
                {
                    _species = Values.Values.V.SpeciesByBlueprint(speciesBlueprint);
                }
                return _species;
            }
        }
